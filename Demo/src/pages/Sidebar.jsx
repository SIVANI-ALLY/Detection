  ...
  return (
    <div style={styles.sidebar}>
      ...
      <div style={styles.menu}>
        ...
        <NavLink to="/upload" style={({ isActive }) => isActive ? styles.menuItemActive : styles.menuItem}>Upload Demo</NavLink>
        <NavLink to="/results" style={({ isActive }) => isActive ? styles.menuItemActive : styles.menuItem}>View Results</NavLink>
      </div>
